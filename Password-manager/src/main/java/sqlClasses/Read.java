...
public class Read {
	 ...
	 */
	public static String[][] getMailData(String masterPasswort, String pathToDb) {
	...
	public static String[] readKeysWeb(String pathToDb) {
		String[] webPageNames = null;
		Connection con = DbConnector.connect(pathToDb);
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			webPageNames = new String[GetNrOfEntries.getNrOfEntrys("Keys", pathToDb)];
	...
	public static String[] getData(int primaryId, String masterPasswort, String pathToDb) {
	...
	public static String[][] readTableKeys(String masterPasswort, String pathToDb) {
		int size = GetNrOfEntries.getNrOfEntrys("Keys", pathToDb);
	...
	public static String[][] readTableMails(String masterPasswort, String pathToDb) {
		int size = GetNrOfEntries.getNrOfEntrys("Mails", pathToDb);
